"""DINOv2 ViT-S/16 on ImageNet-10 (Imagenette). 20 epochs, 1 GPU, no W&B."""
...
from stable_pretraining.methods.dinov2 import DINOv2
...
def main():
    ...
    trainer = standard_trainer(
        callbacks, max_epochs=max_epochs, log_name="dinov2-vits-inet10"
    )
