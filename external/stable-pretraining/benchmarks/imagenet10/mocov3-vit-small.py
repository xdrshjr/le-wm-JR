"""MoCo v3 ViT-S/16 on ImageNet-10 (Imagenette). 20 epochs, 1 GPU, no W&B."""
...
from stable_pretraining.methods.mocov3 import MoCov3
...
def main():
    ...
    trainer = standard_trainer(
        callbacks, max_epochs=max_epochs, log_name="mocov3-vits-inet10"
    )
